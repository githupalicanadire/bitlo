...
// Debug: Log IdentityServer configuration
var identityServerBaseUrl = builder.Configuration["IdentityServer:BaseUrl"];
Console.WriteLine($"🔐 IdentityServer BaseUrl: {identityServerBaseUrl}");
